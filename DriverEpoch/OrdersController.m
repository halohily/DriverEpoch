...
#import "OrderCell.h"
@interface OrdersController ()<UITableViewDelegate, UITableViewDataSource>
...
- (void)setupData
{
    ...
    NSDictionary *parameters = @{@"if": @"GetOrders", @"user_id":user_id};
    ...
    [manager POST:SERVER_ADDRESS parameters:parameters progress:^(NSProgress * _Nonnull downloadProgress) {
          ...
          success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
              ...
              if (code.intValue == 1)
              {
                  ...
                  self.tableData = [tempDic objectForKey:@"orders_list"];
